import { ECDSAProvider, Operation, ParamCondition, SessionKeyProvider } from "@zerodev/sdk";
...
export async function sessionKey({ project, owner, publicClient, erc721, provider}: SessionKeyOptions, expect: ExpectStatic) {
