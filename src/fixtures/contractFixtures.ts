...
export const contractFixtures: Parameters<
  typeof test.extend<ContractFixtures>
>[0] = {
  ...Object.fromEntries(
...
export const withContractFixtures = (environment: TestAPI = test) =>
  environment.extend<ContractFixtures>(contractFixtures);
